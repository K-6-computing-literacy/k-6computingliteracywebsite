...
#### Intermediate-Advanced (Grades 5-6)
...
- Build a game where players have to run away from evil sprites
- Players must have their sprite controlled by the keyboard
- The evil sprite must be controlled autonomously
- Add lives to make the game more challenging
- Include a "Game Over" message when the player loses all lives
...
example game: ![Example Game](/images/21ActivityArcadeEx.png)
