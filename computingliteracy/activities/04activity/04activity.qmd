...
categories: ["Grade: Kindergarten", "Grade: 1", "Grade: 2", "Grade: 3", "Grade: 4", "Grade: 5", "Grade: 6", "Time: Varies"]
toc: true
page-layout: full
---
...
In this activity, students will create and navigate map routes through block code using the IPAD apps. The activity is designed with increasing difficulty by previous code and STEM experience, allowing students to build their programming logic as they play.
...
- Robot (Bee Bot, Blue Bot, or Dash)
- IPAD
- Item Cards
- Map (optional)
